...
export class Backend implements backendInterface {
    ...
    async retryMessage(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.retryMessage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setPersonality(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setPersonality(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
